    ...
    Database:
        ...
        - Write new email
            ...
            - Kafka does a lot of things very nicely, especially allowing multiple consumer groups to consume
              messages within the queue at different rates and for different reasons. We may want to process emails and
              run moderation separately to action against emails that contain illegal content.
"""